...
public:
	...
	void render(void)
	{
		glBegin(GL_LINES);
		glColor3d(1, 0, 0);
		glVertex3d(Position.X + Cam->_Direction.X * 2, Position.Y + Cam->_Direction.Y * 2, Position.Z + Cam->_Direction.Z * 2);
	...
	void update(float elapsed)
	{
		...
		NYVert3Df camPos = NYVert3Df(0,0,Height);
		Cam->moveTo(Position + camPos);
	}
};
